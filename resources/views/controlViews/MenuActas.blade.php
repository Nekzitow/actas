                    ...
                    @foreach ($grupos as $grupo)
                      <tr id={{ $grupo->id}}>
                        ...
                        <td>
                          ...
                          <a class="btn btn-danger" onclick="setValue({{ $grupo->id }},{{ $grupo->id_ciclos }},{{ $grupo->id_carrera }},'{{ $grupo->modalidad }}',this)">
                            <i class="fa fa-trash fa-lg"></i>
                          </a>
                          <a href="/modules/actas/grupo/{{ $grupo->id }}/{{ $grupo->id_ciclos }}/{{ $grupo->id_carrera }}/{{$grupo->modalidad}}"  class="btn btn-primary" title="Ver Actas">
